		...
		<div class="row">
			<div class="col-xs-12">
				<div class="card">
					...
					<div class="card-body">
						<?php echo form_open_multipart('admin/articles/insert');?>
						<!--<form action="<?php echo base_url('admin/articles/insert')?>" method="post" enctype="multipart/formdata">-->
							<div class="col-lg-8">
								<div class="form-group">
									<label>Judul</label>
									<input type="text" class="form-control" name="judul" placeholder="Masukan judul artikel" value="<?php echo set_value('judul');?>">
