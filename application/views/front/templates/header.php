    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="<?php echo base_url('page/about-akhirwan'); ?>">About</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll" href="<?php echo base_url('category/akhirwan-skills'); ?>">certified skills</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll" href="<?php echo base_url('category/akhirwan-experiences'); ?>">Experiences</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll" href="<?php echo base_url('category/akhirwan-portfolio'); ?>">Portfolio</a>
          </li>
		  <li class="nav-item">
